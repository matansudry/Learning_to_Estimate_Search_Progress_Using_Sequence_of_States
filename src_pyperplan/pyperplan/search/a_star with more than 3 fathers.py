...
def astar_search(
    ...
    while open_list:
        ...
        resutls.append((cnt, f, BF, h, f-h, father_n, father_BF, father_f, father_h, father_g, grandfather_n, grandfather_BF,grandfather_f, grandfather_h, grandfather_g, h0, H_min, cnt - last_H_min_update))
            ...
            if task.goal_reached(pop_state):
                with open(output_name+'.csv', 'w', newline='') as myfile:
                    ...
                    temp = ["node#", "node_f",  "BF", "node_h", "node_g", "father_node#", "father_BF", "father_node_f", "father_node_h", "father_node_g",
                            "grandfather_node#", "grandfather_BF", "grandfather_node_f", "grandfather_node_h", "grandfather_node_g", "H0", "H_min", "last_H_min_update","node_max"]
                    wr.writerow(temp)
